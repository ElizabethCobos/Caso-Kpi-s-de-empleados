...
#--- PAGE CONFIG ---#
st.set_page_config(page_tittle="Socialize your knowledge",
                    page_icon="busts_in_silhoutte:")
...
st.markdown("Within this site you are able to filter by gender, performance score, marital status to make a more profund\
            ...
            are between 30-60 years but the salary is given according to the position they have. We can also appreciate that most of the\   employees have a performance score of 3 and that the worked hours does not influence that score.")
